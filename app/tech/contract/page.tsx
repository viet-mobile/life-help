    ...
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 text-center sm:text-left">
          <span className="droplet-pill bg-blue-900/40 px-3 py-1 text-xs font-bold text-blue-300 border border-blue-700/50">
        ...
        {error && (
          <div className="mt-6 droplet-card bg-red-900/30 border border-red-700/60 p-4 text-sm text-red-200">
            ⚠️ {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-8">
          ...
          <div className="droplet-card border border-slate-800 bg-slate-900/70 p-6 sm:p-7 backdrop-blur-md">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full droplet-input border border-slate-700 bg-slate-800 p-3 text-sm font-bold text-white outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full droplet-input border border-slate-800 bg-slate-800/50 p-3 text-sm font-bold text-blue-300 cursor-not-allowed"
                />
              </div>

              <div className="sm:col-span-2">
                <div className="droplet-card border border-blue-800/40 bg-blue-950/30 p-4 text-xs text-blue-200">
              ...
              {services.map((srv) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2.5 droplet-card border p-3 text-left transition ${
                      isSelected
          ...
          <div className="droplet-card border border-slate-800 bg-slate-900/70 p-6 sm:p-7 backdrop-blur-md">
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row">
              ...
              <button
                ...
                className="droplet-btn bg-blue-600 px-4 py-2.5 text-xs font-extrabold text-white shadow-sm hover:bg-blue-500"
              >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {selectedRegions.map((reg, idx) => (
                <span
                  ...
                  className="flex items-center gap-1.5 droplet-pill border border-blue-700/60 bg-blue-950/60 px-3 py-1.5 text-xs font-bold text-blue-200"
                >
                ...
                {DAYS_OF_WEEK.map((d) => {
                  ...
                  return (
                    <button
                      ...
                      className={`h-10 w-10 droplet-btn font-bold text-sm transition ${
                        isChecked
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 grid gap-2 sm:grid-cols-2">
                {TIME_PRESETS.map((preset) => (
                  <label
                    key={preset}
                    className={`flex items-center gap-2.5 droplet-card border p-3 cursor-pointer transition text-xs font-bold ${
              ...
              <div className="mt-2 flex items-center gap-2">
                <input
                  ...
                  className="w-full droplet-input border border-slate-700 bg-slate-800 p-2.5 text-xs font-bold text-white outline-none focus:border-blue-500"
                />
                <button
                  type="button"
                  onClick={() => setShowHoursPicker(true)}
                  className="droplet-btn border border-blue-500 bg-blue-900/40 px-3 py-2 text-xs font-bold text-blue-300 hover:bg-blue-800 transition shrink-0 cursor-pointer"
                >
          ...
          <div className="droplet-banner border border-blue-900/60 bg-blue-950/40 p-6 sm:p-7 backdrop-blur-md">
            ...
            <div className="mt-3 droplet-card bg-slate-900/80 border border-slate-800 p-4 text-xs leading-relaxed text-slate-300 space-y-3 font-medium">
              <p>
            ...
            <div className="mt-6 border-t border-blue-900/40 pt-4">
              ...
              <input
                ...
                className="mt-1.5 w-full droplet-input border border-blue-700 bg-slate-900 p-3 text-base font-extrabold text-white outline-none focus:border-blue-400 tracking-wider"
              />
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
            <Link
              href="/tech"
              className="droplet-btn border border-slate-700 bg-slate-800/90 px-6 py-3.5 text-center text-sm font-bold text-slate-300 hover:bg-slate-700 hover:text-white shadow-2xs active:scale-[0.98] transition cursor-pointer"
            >
              {isKorean ? "취소" : "Cancel"}
            </Link>
